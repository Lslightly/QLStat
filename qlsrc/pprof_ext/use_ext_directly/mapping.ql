...
select id, memory_start.toString(), memory_limit.toString(), file_offset.toString(), filename, build_id, has_functions, has_filenames, has_line_numbers, has_inline_frames
