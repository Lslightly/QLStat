...
select sink, source, sink, "This variable might be zero leading to a division-by-zero panic.", source.getNode().asExpr().getLocation(), sink.getNode().asExpr().getLocation()
